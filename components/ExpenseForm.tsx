        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-70 flex justify-center items-center p-4 z-50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative animate-fade-in-up overflow-hidden">
                ...
                <div className="bg-indigo-600 p-5 flex justify-between items-center text-white">
                    <h3 className="text-xl font-bold tracking-wide">{expenseToEdit ? 'Edit Expense' : 'Add New Expense'}</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-100">
                        ...
                        <div className="relative flex items-center justify-center">
                            <IndianRupee className="absolute left-4 text-indigo-600 h-8 w-8" />
                            <input 
                                type="number" 
                                value={amount} 
                                onChange={(e) => setAmount(e.target.value)} 
                                className="w-full bg-white p-3 pl-12 text-center text-3xl font-extrabold text-indigo-900 rounded-lg border-2 border-indigo-200 focus:border-indigo-600 focus:outline-none placeholder-indigo-200"
                                placeholder="0" 
                                autoFocus
                            />
                        </div>
